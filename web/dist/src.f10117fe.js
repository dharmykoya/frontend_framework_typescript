...
var rootUrl = 'http://localhost:3000/users'; // const rootUrl = 'http://localhost:3000'
...
function () {
  ...
  View.prototype.mapRegions = function (fragment) {
    ...
    for (var regionsMapKey in regionsMap) {
      var selector = regionsMap[regionsMapKey];
      var element = fragment.querySelector(selector);

      if (element) {
        this.regions[regionsMapKey] = element;
      }
    }
  };
...
var UserList_1 = require("./views/UserList"); // import {UserEdit} from "./views/UserEdit";
//
//
